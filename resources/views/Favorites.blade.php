                            ...
                            <div class="p-6 text-gray-900">
                                <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: space-between;">
                                    ...
                                    <div class="item-card" style="flex: 1 0 21%; max-width: 18rem;">
                                        ...
                                        <div class="card">
                                            <img src="{{ asset('storage/' . $favorite->item_image) }}" class="card-img-top" style="width: 200px; height: 200px; object-fit: cover;">
                                            <div class="card-body p-4" style="text-align: center;">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('Detail', $favorite->id) }}" class="btn btn-primary">View More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
