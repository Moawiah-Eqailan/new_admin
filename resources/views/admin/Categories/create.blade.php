...
<div class="create-category-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">
                <i class="fas fa-folder-plus me-2"style="margin: 8px;"></i>
                Create New Category
            </h2>
            <p class="form-subtitle">Add a new category to your product catalog</p>
        </div>

        <form action="{{ route('Categories.store') }}" method="POST" enctype="multipart/form-data" class="category-form">
            @csrf
