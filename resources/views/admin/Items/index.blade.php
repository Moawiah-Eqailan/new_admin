                ...
                <tr class="item-row">
                    ...
                    <td>
                        <div class="image-container">
                            <img src="{{ asset('storage/' . $rs->item_image) }}" class="item-image" alt="{{ $rs->item_name }}"style="object-fit: contain;">
                        </div>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('Items.show', $rs->id) }}" class="action-btn view-btn" title="View Details">
                            ...
                            @endif
                            <a href="{{ route('Items.edit', $rs->id) }}" class="action-btn edit-btn" title="Edit">
