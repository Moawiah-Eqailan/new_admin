...
<div class="detail-item-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Viewing item information</p>
        </div>
        ...
        <div class="item-form">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="product_id" class="form-input" disabled>
        ...
        <div class="item-form">
            ...
            <div class="form-group">
                <label class="form-label">
                    <i class="fas fa-align-left me-2" style="margin: 8px;"></i>
                    Description
                </label>
                <textarea class="form-input"
                    name="description"
                    readonly disabled>{{ $item->item_description }}</textarea>
            </div>
