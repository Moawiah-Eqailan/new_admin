...
<div class="create-category-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-subtitle">Update your product information</p>
        </div>

        <form action="{{ route('products.update', $product->product_id) }}" method="POST" enctype="multipart/form-data" class="category-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <div class="file-upload-wrapper">
                    <div class="file-upload-preview" id="imagePreview">
                        <img src='{{asset("storage")}}/{{$product->product_image}}' class="card-img-top" style="max-width: 100%; max-height: 200px; border-radius: 8px;object-fit: contain;">
                    </div>
                    <input type="file"
                        name="image"
                        id="image"
